...
deploy:
	sam deploy --guided --no-fail-on-empty-changeset --no-confirm-changeset --stack-name ${STACK_NAME} --template-file ./deployment/template.yml
